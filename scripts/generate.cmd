...
set TRAIN_VAL_DIR=data/instructions/train_val
# Configuration - Change these variables to test different models and output directories
set EMBEDDING_DIR=data/embeddings/llama3.1  # Output directory for embeddings
set NICKNAME=llama3.1
set MODEL_NAME=meta-llama/Llama-3.1-8B-Instruct  # Model name from HuggingFace
